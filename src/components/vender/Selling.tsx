  ...
  return (
    <>
      ...
      <div style={{ padding: "5%" }} className="bg-white">
        ...
        <form
          style={{ background: "#6C430E", padding: "3%", width: "200%" }}
          action="#"
          method="POST"
          className="mx-auto form mt-16 border-black max-w-xl sm:mt-20"
        ...
        >
          <div>
            <div>
              <label
                htmlFor="raza"
                className="block text-white font-semibold text-gray-900"
              >
                Raza
              </label>
            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  type="text"
                  name="disciplina"
                  autoComplete="family-disciplina"
                  value={discipline}
            ...
            <div>
              <label
                htmlFor="price"
                className="block text-white font-medium text-gray-900"
              >
                Price
              </label>
              <div className="mt-2">
            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  id="descuentoDelPrecio"
                  type="number"
                  name="descuentoDelPrecio"
                  autoComplete="family-descuentoDelPrecio"
                  value={discountPrice}
          ...
          <div>
            <button
              type="submit"
              style={{ marginTop: "3%", background: "white" }}
              className="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-black font-semibold text-black hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              Publicar
            </button>
          </div>
