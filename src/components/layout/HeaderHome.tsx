...
export function HeaderHome() {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-50 bg-[#1F140D] transition-all duration-300 ${
          isScrolled
            ? "shadow-lg shadow-black/30 backdrop-blur-md bg-[#1F140D]/95"
            : ""
        }`}
      >
        <div className="w-full px-6 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <div
              style={{ margin: "1%" }}
              className="hidden md:flex items-center gap-5 text-sm text-white"
            >
              <Link
                href="/register"
              ...
              <Link
                href="/login"
                style={{ background: "#C9A24D", padding: "10px" }}
                className="font-semibold" /*hover:text-[#C9A24D] transition-colors"*/
              >
                Iniciar sesión
              </Link>
            </div>
